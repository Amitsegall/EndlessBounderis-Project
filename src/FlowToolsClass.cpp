...
//  flowToolsExample
//
//  Created by Amit Segall on 17/04/2018.
//
//
...
void FlowToolsClass::setupGui() {
    ...
    doFullScreen.addListener(this, &FlowToolsClass::setFullScreen);
    ...
    drawMode.addListener(this, &FlowToolsClass::drawModeSetName);
    ...
    displayScalarScale.addListener(this, &FlowToolsClass::setDisplayScalarScale);
    visualizeParameters.add(velocityFieldScale.set("velocity scale", 0.1, 0.0, 0.5));
    velocityFieldScale.addListener(this, &FlowToolsClass::setVelocityFieldScale);
    visualizeParameters.add(temperatureFieldScale.set("temperature scale", 0.1, 0.0, 0.5));
    temperatureFieldScale.addListener(this, &FlowToolsClass::setTemperatureFieldScale);
    visualizeParameters.add(pressureFieldScale.set("pressure scale", 0.02, 0.0, 0.5));
    pressureFieldScale.addListener(this, &FlowToolsClass::setPressureFieldScale);
    visualizeParameters.add(velocityLineSmooth.set("line smooth", false));
    velocityLineSmooth.addListener(this, &FlowToolsClass::setVelocityLineSmooth);
...
//--------------------------------------------------------------
void FlowToolsClass::update(ofFbo simpleCam){
...
//--------------------------------------------------------------
void FlowToolsClass::keyPressed(int key){
    switch (key) {
        case 'G':
...
//--------------------------------------------------------------
void FlowToolsClass::drawModeSetName(int &_value) {
    switch(_value) {
...
//--------------------------------------------------------------
void FlowToolsClass::drawComposite(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void FlowToolsClass::drawParticles(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidFields(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidDensity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidVelocity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofClear(0,0);
        ofEnableBlendMode(OF_BLENDMODE_ALPHA);
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidPressure(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofClear(255);
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_ALPHA);
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidTemperature(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidDivergence(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidVorticity(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidBuoyance(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void FlowToolsClass::drawFluidObstacle(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void FlowToolsClass::drawMask(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void FlowToolsClass::drawOpticalFlow(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    if (showScalar.get()) {
        ofEnableBlendMode(OF_BLENDMODE_ALPHA);
...
//--------------------------------------------------------------
void FlowToolsClass::drawSource(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_DISABLED);
...
//--------------------------------------------------------------
void FlowToolsClass::drawMouseForces(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofClear(0,0);
...
//--------------------------------------------------------------
void FlowToolsClass::drawVelocityDots(int _x, int _y, int _width, int _height) {
    ofPushStyle();
    ofEnableBlendMode(OF_BLENDMODE_ADD);
